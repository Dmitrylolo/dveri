...
var cmeData = {
	...
	'fields' 				: 'Имя (Ваше имя), =Номер телефона (Ваш телефон)*, =Комментарий (Например: Хочу установить дверь до 2000 грн), !Ваш вопрос!Взывать замерщика!Помочь в выборе!Сделать заказ!, ?Подарочная упаковка',
