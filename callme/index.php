...
<title>Callme 2.3 — скрипт обратного звонка</title>
</head>
<body>
	...
	<div class="container">
		<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a target="_blank" href="http://get.nazartokar.com">Купить лицензию</a></li>
				<li><a target="_blank" href="http://dedushka.org/scripts">Заказать установку</a></li>
			</ul>
		</nav>
	</div>
</div>
...
<header class="jumbotron subhead">
	<div class="container text-center">
		<h1><a href="http://dedushka.org/tag/callme">Callme</a> <small>2.3</small></h1>
...
<div class="container">
	<h2>Пример</h2> 
	<p>Давайте посмотрим, как работает Callme. Нажмите на любую из ссылок ниже. <a href="#" class="callme_viewform">Кликайте на любую ссылку</a>, чтобы показать форму заказа. <a href="#" class="callme_viewform" data-cme="Атрибут ссылки">Это ссылка с атрибутом</a>, который нужно указать в поле <code>data-cme</code>. <a href="#" class="callme_viewform">Кликайте</a> на любую из них повторно, чтобы форма скрылась.</p>
	...
	<div class="row">
		<div class="item col-md-6">
			...
			<ul>
				<li><a href="stuff/img/apple.png" class="template_preview">apple</a> (в стиле Apple)</li>
				<li><a href="stuff/img/default.png" class="template_preview">default</a> (по умолчанию, самый крутой)</li>
				<li><a href="stuff/img/blackred.png" class="template_preview">blackred</a> (красно-чёрный)</li>
				<li><a href="stuff/img/vk.png" class="template_preview">vk</a> (ВКонтакте)</li>
				<li><a href="stuff/img/fb.png" class="template_preview">fb</a> (Facebook)</li>
				<li><a href="stuff/img/pink.png" class="template_preview">pink</a> (розовый)</li>
				<li><a href="stuff/img/yellow.png" class="template_preview">yellow</a> (жёлтый)</li>
			</ul>
		</div>
		<div class="item col-md-6">
			<img src="stuff/img/default.png" id="template_preview" alt="" class="img-responsive">
		</div>
	</div>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-md-3">
			...
			<p>Устанавливайте только оригинальный архив, скачанный с моего сайта. Не ставьте взятые у каких-то других разработчиков моды и копии  Callme, я не отвечаю за их работу, а также за то, что они могут сделать с вашим сайтом. </p>
			<p>Главная инструкция для настройки <a href="http://dedushka.org/kod/5213.html">находится здесь</a>.</p>
		</div>
		<div class="col-md-3">
			<h3 class="page-header">SMS и SMTP</h3>
			<p>Для получения уведомлений в смс можно настроить работу с SMS-сервисами по <a href="http://dedushka.org/kod/3903.html">этой инструкции</a>.</p>
			<p>Если вместо обычной отправки сообщений вам нужно отправлять их по SMTP, для вас я написал <a href="http://qbx.me/viewtopic.php?t=108">такую инструкцию</a>.</p>
		</div>
		<div class="col-md-3">
			<h3 class="page-header">Лицензия</h3>
			<p>Как вы помните, скрипт бесплатный. Всё же сам он себя не напишет и мне приходится тратить много времени на его поддержку и обновление. Если вы хотите, то можете поддержать разработку, купив лицензию. В ответ я дам вам скрипт лицензии, который можно добавить в конфиг, чтобы убрать ссылку на мой блог из формы. Вот <a href="http://get.nazartokar.com/#payments">реквизиты для оплаты</a>, а вот <a href="http://dedushka.org/kod/6046.html">инструкция</a>. Спасибо.</p>
		</div>
		<div class="col-md-3">
...
<script type="text/javascript" src="/callme/js/callme.min.js" charset="utf-8"></script>
</body>
</html>