		...
		<table class="table table-hover">
		 ...
		 <tbody> 
		  <tr style=" background: #EEEEEE;">
		   ...
		   <td style="width:250px;"><?php echo $entry_ratek; ?></td>
		   <td><input type="text" name="ratek" value="<?php echo $supplers['ratek']; ?>" maxlength="13" size="8" /></td>
		   <td></td>
		  </tr>	  
		 </tbody>		
		 <tbody>
		  <tr>	
		   ...
		   <td><input type="text" name="points" value="<?php echo $supplers['points']; ?>" maxlength="64" size="18" title = "e.g. class=&quot;product_param&quot;&gt;"/><br /><br /><br /><input type="text" name="places" value="<?php if (isset($supplers['places'])) echo $supplers['places']; ?>" maxlength="4" size="4" title = "1 - by default"/></td>
		   ...
		   <tr style=" background: #EEEEEE;">
			...
			<tbody>
			  <tr>
                ...
                <td width="250"><br /><?php echo $entry_mycat; ?><br/><br/><br/><?php echo $entry_parent; ?></td>
		  	    <td><br />
                 <select name="my_cat">
			...
			<tbody>
			 <tr style=" background: #EEEEEE;">
			  ...
			  <td>
                ...
                <?php echo $text_no; ?>
                <?php } ?><br/><br/>
				<input type="text" name="my_qu" value="<?php echo $supplers['my_qu']; ?>" maxlength="128" size="40" title = "e.g. 10-50=20,+=10,++=20,Нет=0,нет=0,Есть=5" /></td><td></td>
             </tr>
			</tbody>
			<tbody>
			 <tr>
			  <td>* <?php echo $entry_price; ?><br/><br/>
			  <?php echo $entry_pars; ?><br/><br/><?php echo $entry_iprice; ?><br/><br/><?php echo $entry_usd; ?></td>
              <td><input type="text" name="price" value="<?php if (isset($supplers['price'])) echo $supplers['price']; ?>" maxlength="128" size="18"  title = "e.g. &lt;/div&gt;&lt;div class=&quot;total-price&quot;&gt;,&lt;/" /><br/><br/><br/><input type="text" name="parsp" value="<?php echo $supplers['parsp']; ?>" maxlength="4" size="4"/><br/><br/><br/>
			  <input type="text" name="bprice" value="<?php if (isset($supplers['bprice'])) echo $supplers['bprice']; ?>" maxlength="4" size="4" />
			  <br/><br/><br/><input type="text" name="usd" value="<?php echo $supplers['usd']; ?>" maxlength="4" size="4"/>
			  </td>
			  <td width="250"><?php echo $entry_point1; ?><br/><br/><br/><?php echo $entry_placep; ?><br/><br/><br/><?php echo $entry_myprice;?></td>
			  <td><input type="text" name="pointp" value="<?php echo $supplers['pointp']; ?>" maxlength="64" size="18" title = "e.g. function slot_go(value)" /><br/><br/><br/><br/>
			  <select name="placep">
			   ...
			   <td style=" background: #E5E2D9;">
				<?php echo '<b>' . $text_competitors . '</b>'; ?><br/><br/>
				 ...
				 <?php if(isset($cheap) and $cheap == 0) { ?>		
                  ...
                  <?php } ?>
				   ...
				   &nbsp;&nbsp;<?php echo $entry_onn;?>&nbsp;&nbsp;
				   <input type="text" name="onn" value="<?php if (isset($supplers['onn'])) echo $supplers['onn']; ?>" maxlength="8" size="4"/>
				 <br /><br />
				 <select name="refer">
				 ...
				 &nbsp;&nbsp;<?php echo $entry_disc;?>&nbsp;&nbsp;
				 <input type="text" name="disc" value="<?php if (isset($supplers['disc'])) echo $supplers['disc']; ?>" maxlength="8" size="4"/><br /><br />
				 <select name="kmenu">
			    ...
			    </td><td style=" background: #E5E2D9;"></td>
             </tr>
			</tbody>
			<tbody>
			 <tr style=" background: #EEEEEE;">
			...
			<tbody>
			  ...
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="pic_ext" value="<?php if (isset($supplers['pic_ext'])) echo $supplers['pic_ext']; ?>" maxlength="128" size="18" title = "e.g. 12,13,18,14" /><br /><br/><br/><input type="text" name="parsk" value="<?php echo $supplers['parsk']; ?>" maxlength="4" size="4"/></td>
			  ...
			  <td width="250"><?php echo $entry_myphoto; ?><br /><br /><?php echo $entry_newphoto; ?></td>
			  <td>
			...
			<tbody>
			 <tr>
			  ...
			  <td width="250" style=" background: #E5E2D9;" /><br /><br /> <?php echo $entry_addseo; ?></td>
			  ...
			  <?php echo $entry_off; ?></td>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td><td style=" background: #E5E2D9;"/></td>
			 </tr>
			</tbody>
			<tbody>
			 <tr>
			...
			<tbody>
			 <tr>
			  ...
			  <td width="250" style=" background: #D8D4C8;" /><?php echo $entry_opt_fotos; ?><br /><br /><?php echo $entry_plusopt; ?>
			...
			<tbody>
			 <tr>
			  ...
			  <select name="newurl">
                  ...
                  <?php } ?>				  			  
                </select></td><td style=" background: #E5E2D9;"/></td>
			</tr>
			</tbody>
			<tbody>
			 <tr>
			...
			<td style=" background: #E5E2D9;"><?php if ($supplers['sleep']) { ?>
				<input type="radio" name="sleep" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="sleep" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="sleep" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="sleep" value="0" checked="checked" />
                <?php echo $text_no; ?>
				<?php } ?></td>	
                ...
                <?php echo $text_no; ?>
				<?php } ?></td></td><td style=" background: #E5E2D9;"></td>	
            </tr>
			</tbody>			
			<tbody>
			 <tr>
			<td><?php echo $entry_ad; ?></td>
              <td><select name="ad">
				 <?php if($supplers['ad'] == 1) { ?>		
                  ...
                  <option value="12" style="color: #0CC72A;" selected="selected"><?php echo $text_ad12; ?></option>
                  <?php } else { ?>
                  <option value="12" style="color: #0CC72A;"><?php echo $text_ad12; ?></option>
                  <?php } ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?>
				</td></td><td style=" background: #E5E2D9;"></td>
			 </tr>
			</tbody>
		</table>		
	  </div> <!-- end General -->
		 ...
		 <tbody>
		   <tr>
			...
			<tr style=" background: #EEEEEE;" />              
              ...
              <td><div style="background: #EEEEEE; overflow-y: scroll; border: 1px solid #CCC; width: 500px; height: 200px;">                  
                  <?php foreach ($categories as $category) { ?>                  
		  ...
		  <tr style=" background: #EEEEEE;" />            
              ...
              <td><input type="text" name="act_sname" maxlength="64" size="32" /> <?php echo $entry_any; ?> </td>
			 <td><strong><?php echo $entry_sdesc; ?></strong></td>
              <td><input type="text" name="act_sdesc" maxlength="64" size="32" /> <?php echo $entry_any; ?> </td>
		  </tr>
		  <tr style=" background: #EEEEEE;" />            
			  <td><strong><?php echo $entry_attribut; ?></strong></td>
              <td><input type="text" name="act_attribut" maxlength="64" size="32" /> <?php echo $entry_any; ?> </td>
			 <td><strong><?php echo $entry_noattribut; ?></strong></td>
              <td><input type="text" name="act_noattribut" maxlength="64" size="32" /> <?php echo $entry_any; ?> </td>
		  </tr>
		  <tr style=" background: #EEEEEE;" />            
			 ...
			 <td><strong><?php echo $entry_isvalue; ?></strong></td>
              <td><input type="text" name="act_isvalue" maxlength="64" size="32" /></td>
		  </tr>
		  <tr style=" background: #EEEEEE;" />            
		  ...
		  <tr>
			 ...
			 <td>
			  <select name="command" onchange="var command = this[this.selectedIndex]; if (command['onclick']) command.onclick();"> 
				  ...
				  <option value="89" style="color: #8F620D;"><?php echo $text_command89; ?></option>
				  <option value="110" style="color: #8F620D;"><?php echo $text_command110; ?></option>
				  <option value="116" style="color: #8F620D;"><?php echo $text_command116; ?></option>
				  <option value="111" style="color: #8F620D;"><?php echo $text_command111; ?></option>
				  <option value="109" style="color: #8F620D;"><?php echo $text_command109; ?></option>
				  <option value="113" style="color: #8F620D;"><?php echo $text_command113; ?></option>
				  <option value="114" style="color: #8F620D;"><?php echo $text_command114; ?></option>
				  ...
				  <option value="15" style="color: #0A10B5;"><?php echo $text_command15; ?></option>				  				  
				  ...
				  <option value="106"><?php echo $text_command106; ?></option>
				  <option value="107"><?php echo $text_command107; ?></option>
				  <option value="108"><?php echo $text_command108; ?></option>
				  ...
				  <option value="90"><?php echo $text_command90; ?></option>
				  ...
				  <option value="92"><?php echo $text_command92; ?></option>
				  ...
				  <option value="91"><?php echo $text_command91; ?></option>				  
				  ...
				  <option value="102"><?php echo $text_command102; ?></option>
				  ...
				  <option value="119" style="color: #8F620D;"><?php echo $text_command119; ?></option>
				  <option value="105" style="color: #8F620D;"><?php echo $text_command105; ?></option>
				  <option value="104" style="color: #8F620D;"><?php echo $text_command104; ?></option>
		  ...
		  <td></td><td></td>
		   <td><strong><?php echo $entry_zactcat; ?></strong></td>
              <td><div style="overflow-y: scroll; border: 1px solid #CCC; width: 500px; height: 200px;">                  
                  <?php foreach ($categories as $category) { ?>                  
                    <div class="<?php if (isset($class)) echo $class; ?>">
