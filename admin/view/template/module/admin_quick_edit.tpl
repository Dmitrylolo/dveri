									...
									<div class="row">
										<div class="col-sm-12">
											<ul class="nav nav-tabs" role="tablist">
												...
												<li><a href="#tab-sales-customers" role="tab" data-toggle="tab"><?php echo $tab_customers; ?></a></li>
												...
												<div class="tab-content">
													...
													<div class="tab-pane fade" id="tab-sales-customers" role="tab">
														<fieldset>
															<div class="form-group">
																<label class="col-sm-3 col-md-2 control-label" for="aqe_sales_customers_status"><?php echo $entry_sales_customers_status; ?></label>
																<div class="col-sm-2 fc-auto-width">
																	<select name="aqe_sales_customers_status" id="aqe_sales_customers_status" data-bind="value: sales_customers_status" class="form-control">
																		<option value="1"><?php echo $text_enabled; ?></option>
																		<option value="0"><?php echo $text_disabled; ?></option>
																	</select>
																</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-6 col-md-5 col-lg-4">
																	<table class="table table-hover table-condensed page-columns sortable">
																		...
																		<tbody>
																			<!-- ko foreach: sales_customers -->
																			<tr  data-bind="attr: {'data-id': column}, css: {'danger': !visible()}">
																				<td><i class="fa fa-arrows-v cur-crosshair"></i></td>
																				<td><!-- ko text: name --><!-- /ko --><input data-bind="value: index, attr: {name:'index[aqe_sales_customers][' + column +']'}" type="hidden" class="column-index" /></td>
																				<td class="text-center"><input data-bind="checked: visible, attr: {name:'display[aqe_sales_customers][' + column +']'}" type="checkbox" class="column-display" /></td>
																				<td class="text-center"><input data-bind="checked: editable, attr: {name:'qe_status[aqe_sales_customers][' + column +']'}, disable: !quick_editable" type="checkbox" /></td>
																			</tr>
																			<!-- /ko -->
																		</tbody>
																	</table>
														...
														<li>
															...
															<div class="btm-mgn">
																...
																<ul class="list-unstyled">
																	...
																	<li>admin/language/english/sale/customer_ext.php</li>
																...
																<ul class="list-unstyled">
																	...
																	<li>admin/language/YOUR_LANGUAGE/sale/customer_ext.php</li>
											...
											<div class="release">
												...
												<blockquote>
													...
													<ul>
														...
														<li>admin/controller/module/admin_quick_edit.php</li>
														<li>admin/controller/sale/customer_ext.php</li>
														<li>admin/view/template/module/admin_quick_edit.tpl</li>
														<li>vqmod/xml/admin_quick_edit.xml</li>
													</ul>
