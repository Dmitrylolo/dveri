...
class ControllerCommonMenu extends Controller {
	...
	public function index() {
		...
		$data["text_suppler"] = $this->language->get("text_suppler");  /*suppler*/ 		$data['text_module'] = $this->language->get('text_module');
		...
		$data['color'] = $this->url->link('catalog/color', 'token=' . $this->session->data['token'], 'SSL');


		$data['marketing'] = $this->url->link('marketing/marketing', 'token=' . $this->session->data['token'], 'SSL'); 


		$data["suppler"] = $this->url->link("catalog/suppler", "token=" . $this->session->data["token"], "SSL");  /*suppler*/ 		$data['module'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
