...
define('EXTENSION_VERSION',         '5.2.0');
...
class ControllerModuleAdminQuickEdit extends Controller {
	...
	private $column_defaults = array(
		'aqe_catalog_products'  => array(
			...
			'filter'            => array('display' => 0, 'qe_status' => 0, 'editable' => 1, 'index' => 310, 'align' =>   'text-left', 'type' =>  'filter_qe', 'sort' => ''                , 'rel' => array('filters'),  'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
	...
	private static $language_texts = array(
		...
		'tab_vouchers', 'tab_campaigns', 'tab_affiliates', 'tab_coupons',
		// Buttons
		...
		'entry_catalog_information_status', 'entry_sales_orders_status', 'entry_sales_returns_status', 'entry_sales_customers_status',
