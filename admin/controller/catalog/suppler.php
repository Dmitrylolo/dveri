...
class ControllerCatalogSuppler extends Controller { 
	 private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	public function getBaseForm() {
		...
		$data['start'] = $this->url->link('catalog/suppler/start', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/suppler_base.tpl', $data));
	...
	$data['insert'] = $this->url->link('catalog/suppler/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
	$data['delete'] = $this->url->link('catalog/suppler/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');	
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'load' => $this->url->link('catalog/suppler/load', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, 'SSL')
			);
		...
		$data['sort_name'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/suppler_list.tpl', $data));
	}
  	...
  	private function getForm() {
		...
		if (!isset($this->request->get['form_id'])) {
			$data['action'] = $this->url->link('catalog/suppler/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('catalog/suppler/update', 'token=' . $this->session->data['token'] . '&form_id=' . $this->request->get['form_id'] . $url, 'SSL');
		}
		
		$data['cancel'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['base'] = $this->url->link('catalog/suppler/base', 'token=' . $this->session->data['token']. $url, 'SSL');		
	...
	//мануальная терапия
		...
		// $id = 13;
		$results = $this->model_catalog_suppler->getSupplerSEO( $id );

		foreach ($results as $result) {
			$action = array( );
			$action[] = array( 'text' => $this->language->get( 'text_edit' ), 'href' => $this->url->link( 'catalog/suppler/update', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, 'SSL' ) );

			$data['seo'] = array( 'prod_title' => $result['prod_title'], 'prod_meta_desc' => $result['prod_meta_desc'], 'prod_desc' => $result['prod_desc'], 'cat_title' => $result['cat_title'], 'cat_meta_desc' => $result['cat_meta_desc'], 'cat_desc' => $result['cat_desc'], 'manuf_title' => $result['manuf_title'], 'manuf_meta_desc' => $result['manuf_meta_desc'], 'manuf_desc' => $result['manuf_desc'], 'prod_keyword' => $result['prod_keyword'], 'prod_h1' => $result['prod_h1'], 'prod_photo' => $result['prod_photo'], 'seo_1' => $result['seo_1'], 'seo_2' => $result['seo_2'], 'seo_3' => $result['seo_3'], 'seo_4' => $result['seo_4'], 'seo_5' => $result['seo_5'], 'seo_6' => $result['seo_6'], 'seo_7' => $result['seo_7'], 'seo_8' => $result['seo_8'], 'seo_9' => $result['seo_9'], 'seo_10' => $result['seo_10'], 'seo_11' => $result['seo_11'], 'seo_12' => $result['seo_12'], 'seo_13' => $result['seo_13'], 'seo_14' => $result['seo_14'], 'seo_15' => $result['seo_15'], 'seo_16' => $result['seo_16'], 'seo_17' => $result['seo_17'], 'seo_18' => $result['seo_18'], 'seo_19' => $result['seo_19'], 'seo_20' => $result['seo_20'], 'action' => $action );

			if ( isset( $this->request->post['prod_title'])) {
				$data['prod_title'] = $this->request->post['prod_title'];
			} else {
				$data['prod_title'] = $result['prod_title'];
			}


			if (isset( $this->request->post['prod_meta_desc'])) {
				$data['prod_meta_desc'] = $this->request->post['prod_meta_desc'];
			} else {
				$data['prod_meta_desc'] = $result['prod_meta_desc'];
			}


			if (isset( $this->request->post['prod_desc'])) {
				$data['prod_desc'] = $this->request->post['prod_desc'];
			} else {
				$data['prod_desc'] = $result['prod_desc'];
			}


			if (isset( $this->request->post['cat_title'])) {
				$data['cat_title'] = $this->request->post['cat_title'];
			} else {
				$data['cat_title'] = $result['cat_title'];
			}


			if (isset( $this->request->post['cat_meta_desc'])) {
				$data['cat_meta_desc'] = $this->request->post['cat_meta_desc'];
			} else {
				$data['cat_meta_desc'] = $result['cat_meta_desc'];
			}


			if (isset( $this->request->post['cat_desc'])) {
				$data['cat_desc'] = $this->request->post['cat_desc'];
			} else {
				$data['cat_desc'] = $result['cat_desc'];
			}


			if (isset( $this->request->post['manuf_title'])) {
				$data['manuf_title'] = $this->request->post['manuf_title'];
			} else {
				$data['manuf_title'] = $result['manuf_title'];
			}


			if (isset( $this->request->post['manuf_meta_desc'])) {
				$data['manuf_meta_desc'] = $this->request->post['manuf_meta_desc'];
			} else {
				$data['manuf_meta_desc'] = $result['manuf_meta_desc'];
			}


			if (isset( $this->request->post['manuf_desc'])) {
				$data['manuf_desc'] = $this->request->post['manuf_desc'];
			} else {
				$data['manuf_desc'] = $result['manuf_desc'];
			}

			if (isset( $this->request->post['prod_keyword'] )) {
				$data['prod_keyword'] = $this->request->post['prod_keyword'];
			} else {
				$data['prod_keyword'] = $result['prod_keyword'];
			}

			if (isset( $this->request->post['prod_h1'] )) {
				$data['prod_h1'] = $this->request->post['prod_h1'];
			} else {
				$data['prod_h1'] = $result['prod_h1'];
			}

			if (isset( $this->request->post['prod_photo'] )) {
				$data['prod_photo'] = $this->request->post['prod_photo'];
			} else {
				$data['prod_photo'] = $result['prod_photo'];
			}


			if (isset( $this->request->post['seo_1'])) {
				$data['seo_1'] = $this->request->post['seo_1'];
			} else {
				$data['seo_1'] = $result['seo_1'];
			}


			if (isset( $this->request->post['seo_2'])) {
				$data['seo_2'] = $this->request->post['seo_2'];
			} else {
				$data['seo_2'] = $result['seo_2'];
			}


			if (isset( $this->request->post['seo_3'])) {
				$data['seo_3'] = $this->request->post['seo_3'];
			} else {
				$data['seo_3'] = $result['seo_3'];
			}


			if (isset( $this->request->post['seo_4'])) {
				$data['seo_4'] = $this->request->post['seo_4'];
			} else {
				$data['seo_4'] = $result['seo_4'];
			}


			if (isset( $this->request->post['seo_5'])) {
				$data['seo_5'] = $this->request->post['seo_5'];
			} else {
				$data['seo_5'] = $result['seo_5'];
			}


			if (isset( $this->request->post['seo_6'])) {
				$data['seo_6'] = $this->request->post['seo_6'];
			} else {
				$data['seo_6'] = $result['seo_6'];
			}


			if (isset( $this->request->post['seo_7'])) {
				$data['seo_7'] = $this->request->post['seo_7'];
			} else {
				$data['seo_7'] = $result['seo_7'];
			}


			if (isset( $this->request->post['seo_8'])) {
				$data['seo_8'] = $this->request->post['seo_8'];
			} else {
				$data['seo_8'] = $result['seo_8'];
			}


			if (isset( $this->request->post['seo_9'])) {
				$data['seo_9'] = $this->request->post['seo_9'];
			} else {
				$data['seo_9'] = $result['seo_9'];
			}


			if (isset( $this->request->post['seo_10'])) {
				$data['seo_10'] = $this->request->post['seo_10'];
			} else {
				$data['seo_10'] = $result['seo_10'];
			}


			if (isset( $this->request->post['seo_11'])) {
				$data['seo_11'] = $this->request->post['seo_11'];
			} else {
				$data['seo_11'] = $result['seo_11'];
			}


			if (isset( $this->request->post['seo_12'])) {
				$data['seo_12'] = $this->request->post['seo_12'];
			} else {
				$data['seo_12'] = $result['seo_12'];
			}


			if (isset( $this->request->post['seo_13'])) {
				$data['seo_13'] = $this->request->post['seo_13'];
			} else {
				$data['seo_13'] = $result['seo_13'];
			}


			if (isset( $this->request->post['seo_14'])) {
				$data['seo_14'] = $this->request->post['seo_14'];
			} else {
				$data['seo_14'] = $result['seo_14'];
			}


			if (isset( $this->request->post['seo_15'])) {
				$data['seo_15'] = $this->request->post['seo_15'];
			} else {
				$data['seo_15'] = $result['seo_15'];
			}


			if (isset( $this->request->post['seo_16'])) {
				$data['seo_16'] = $this->request->post['seo_16'];
			} else {
				$data['seo_16'] = $result['seo_16'];
			}


			if (isset( $this->request->post['seo_17'])) {
				$data['seo_17'] = $this->request->post['seo_17'];
			} else {
				$data['seo_17'] = $result['seo_17'];
			}


			if (isset( $this->request->post['seo_18'])) {
				$data['seo_18'] = $this->request->post['seo_18'];
			} else {
				$data['seo_18'] = $result['seo_18'];
			}


			if (isset( $this->request->post['seo_19'])) {
				$data['seo_19'] = $this->request->post['seo_19'];
			} else {
				$data['seo_19'] = $result['seo_19'];
			}


			if (isset( $this->request->post['seo_20'])) {
				$data['seo_20'] = $this->request->post['seo_20'];
			} else {
				$data['seo_20'] = $result['seo_20'];
			}
		}

		$session = time() . 'session';
	//	$data['statuses'] = $this->model_catalog_suppler->getStatus($c_class, $session);
		$s = 0;
		$a = 0;
		$data['statuses'] = $this->model_catalog_suppler->getStatus($c_class, $s, $a);
		...
		$this->response->setOutput($this->load->view('catalog/suppler_form.tpl', $data));
	} 	
