...
class ModelReportProduct extends Model {
	...
	public function getPurchased($data = array()) {
		$sql = "SELECT op.name, op.model, SUM( op.total - op.bprice * op.quantity) AS profit, /*suppler*/ SUM(op.quantity) AS quantity, SUM((op.total + op.tax) * op.quantity) AS total FROM " . DB_PREFIX . "order_product op LEFT JOIN `" . DB_PREFIX . "order` o ON (op.order_id = o.order_id)";
