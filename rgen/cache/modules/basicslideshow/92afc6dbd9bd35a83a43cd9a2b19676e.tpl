<div id="rgen-basicslideshow-rgenr3cfaZ" class="rgen-basicslideshow basicslideshow-rger0">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgenr3cfaZ > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgenr3cfaZ .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgenr3cfaZ .slideshow").sudoSlider({
		responsive: true,
