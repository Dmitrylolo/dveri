<div id="rgen-contentblocks-rgenCgbuHo" class="rgen-contentblocks contentblocks-rgQtX">
		...
		<div class="text-wrp">
						...
						<div class="text">ru - No data</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenCgbuHo .contentblock-grid', '#rgen-contentblocks-rgenCgbuHo .contentblock-grid > .cl');
								});
								</script>
