<div id="rgen-contentblocks-rgen67LADo" class="rgen-contentblocks contentblocks-rgQtX">
				...
				<div class="mod-content">
											...
											<div class="rw gt0 mb0">
														<div class="cl cl12 d-xl12 t-xl12 m-xl12 m-sm12 m-xs12 ">
																...
																<div class="contentblock-grid rw eq4 d-eq4 t-eq4 mxl-eq2 msm-eq1 mxs-eq1 gt20 mb10">
																		<div class="cl">
		...
		<div class="text-wrp">
						...
						<div class="text">ru - No data</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgen67LADo .contentblock-grid', '#rgen-contentblocks-rgen67LADo .contentblock-grid > .cl');
								});
								</script>
